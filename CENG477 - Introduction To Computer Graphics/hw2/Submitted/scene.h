...
namespace fst
{
    ...
    struct Scene
    {
        ...
        Mesh modelingTransformation(Mesh &mesh,int material_id);
        Sphere sphereModelingTransformation(Sphere &shpere,int material_id);
        HitRecord pointModelingTransformation(HitRecord vec, std::string transformations) const;
    };
} // namespace fst
