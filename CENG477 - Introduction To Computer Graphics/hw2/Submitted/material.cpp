...
namespace fst
{
    ...
    math::Vector3f Material::computeBrdf(const math::Vector3f& wi, const math::Vector3f& wo, const math::Vector3f& normal, const math::Vector3f& renk, const std::string& decal) const
    {
        ...
        if(decal == "replace_all"){
            return m_specular * specular;
        }
        return m_specular * specular +  renk * diffuse;
    }
