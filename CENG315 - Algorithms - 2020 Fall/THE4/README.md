...
1. You need to implement the ```recursive``` solution and return the optimal value and number of recursive calls ( it is easier to count at the exact time when the function starts executing)

2. You need to implement the ```recursive+memoization``` solution and return the optimal value and number of recursive calls ( it is easier to count at the exact time when the function starts executing)

3. You need to implement the ```tabulation``` solution and return the optimal value and number of total iterations in the tabulation loop 
