...
1. You must buy only one stock at a given time (discrete time steps)
2. You cannot buy a stock twice.
3. You cannot buy a stock at a given time if a bigger id stock is already been bought in earlier time steps. (e.g. if you choose to buy stock 5 at time t=2, you cannot consider buying stocks 0,1,2,3 or 4 after that point, i.e. for t = 3,4 ...)
